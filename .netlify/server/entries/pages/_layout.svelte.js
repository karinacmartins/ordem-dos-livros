import { V as spread_props, W as slot, X as sanitize_props, Y as fallback, Z as escape_html, _ as bind_props, $ as attr, T as pop, R as push } from "../../chunks/index.js";
...
function Cabecalho($$payload) {
  $$payload.out += `<header class="flex justify-center items-center h-24 border-b border-zinc-800">`;
  Logo($$payload);
  $$payload.out += `<!----></header>`;
}
function Rodape($$payload, $$props) {
  ...
  $$payload.out += `<footer class="flex justify-between items-center px-5 sm:px-20 h-16 border-t border-zinc-800"><div class="font-thin text-zinc-400 flex items-center gap-2"><p>© ${escape_html(currentYear)}. KM Todos os direitos reservados.</p> <span>Made with 🤍</span></div> <div class="flex items-center gap-4"><a href="https://www.linkedin.com/in/karinacmartins/" target="_blank" title="LinkedIn" aria-label="LinkedIn de Karina Martins"><img src="/linkedin-round-svgrepo-com.svg" alt="LinkedIn" class="h-6 w-6"></a> <a href="https://github.com/karinacmartins" target="_blank" title="GitHub" aria-label="GitHub de Karina Martins"><img src="/github-round-svgrepo-com.svg" alt="GitHub" class="h-6 w-6"></a> <a href="https://www.instagram.com/karinamartins_eu/" target="_blank" title="Instagram" aria-label="Instagram de Karina Martins"><img src="/instagram-round-svgrepo-com.svg" alt="Instagram" class="h-6 w-6"></a> <a href="https://portfolio-pessoal-mocha.vercel.app/" target="_blank" title="Portfólio" aria-label="Portfólio de Karina Martins"><img src="/portfolio.png" alt="Portfólio" class="h-6 w-6"></a></div></footer>`;
  pop();
}
function Pagina($$payload, $$props) {
  $$payload.out += `<div class="flex flex-col min-h-screen bg-black text-white">`;
  Cabecalho($$payload);
  $$payload.out += `<!----> <div class="flex-1 flex gap-5 max-w-7xl mx-auto w-full p-5"><main class="flex-1"><!---->`;
  slot($$payload, $$props, "default", {});
  $$payload.out += `<!----></main> `;
  AreaLateral($$payload);
  $$payload.out += `<!----></div> `;
